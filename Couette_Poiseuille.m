...
% ==================================================================
% ---- Linear stability of Plane Couette-Poiseuille flow (PCPF) ----
% ==================================================================

% Use of spectral methods to solve the Orr-Sommerfeld equation adjusted for
% plane Poiseuille-Couette flow. Base flow is different from the purely
...
%% Attempt of using finite-difference methods
% % 
% c = [];
% Re = 3848;
% alpha = 1.0;
